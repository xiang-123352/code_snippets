...
import AllgemeinesKontoMitTagesumsatz as akmt, GirokontoKundendaten as gk


class GirokontoMitTagesumsatz(akmt.AllgemeinesKontoMitTagesumsatz):


	def __init__(self, inhaber, kontonummer, kontostand, max_tagesumsatz = 1500):
		kundendaten = gk.GirokontoKundendaten(inhaber, kontonummer)
		akmt.AllgemeinesKontoMitTagesumsatz.__init__(self, kundendaten, kontostand, max_tagesumsatz)
